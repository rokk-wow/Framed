...
--[[ AddCastbar
Creates and configures an oUF Castbar element on the given frame.
The castbar is positioned relative to the parent frame per config.
Width defaults to the parent frame width if not provided.
* frame     - the oUF unit frame
* cfg       - the unit's modules.castbar config table
--]]
function addon:AddCastbar(frame, cfg)
    ...
    -- Color: apply the default cast color, then swap dynamically per state
